...
class Dzangocart
{
	...
	protected static function processQuery(
		$query_info,
		$params = array(),
		$with_headers = false) {
	...
	public static function getSogenactifTransactions(array $params = array(), $test = false)
	{
		$url = '/sogenactif.json';
		$query = $params;
		if ($test) { $query['test'] = true; } else { $query['merchant_id'] = sfConfig::get('app_dzangocart_sips_merchant_id'); }
	...
	public static function getPaypalDirectTransactions(
		array $params = array(),
		$test = false,
		$sort_by = null,
		$list_by = null,
	...
	public static function getPaypalExpressTransactions(
		array $params = array(),
		$test = false,
		$sort_by = null,
		$list_by = null,
